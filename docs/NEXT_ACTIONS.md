...
1. **Await Director playtest verdict** on the fixed field inspector panel (and the four scripted
   runs in PLAYTEST_SCRIPT_PHASE_1.md). Playtest notes outrank everything below.
